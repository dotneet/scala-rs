//! E2E tests for lazysig (signatures completed on demand, nsc's lazy
//! completers) and impl2 (polymorphic implicit defs/vals: type-parameter
//! unification). Split out of `e2e.rs`.
