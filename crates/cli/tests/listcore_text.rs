//! E2E tests for the core members of `scala.collection.immutable.List`
//! (`list_core*`, see `crates/typer/src/prelude_seq.rs`) and the
//! String/StringBuilder/Range/numeric enrichment in
//! `crates/typer/src/prelude_text.rs`. Split out of `e2e.rs`.
