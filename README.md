...
- Lexical lambda/type contexts and Java field storage boundaries are covered
  ...
  Generated by-name thunk provenance, callable function values, stable local
  alias imports and case-copy/access boundaries are covered by the
  [copy and by-name recovery batch](docs/batches/copy-byname-recovery.md).
