...
object Main {
  ...
  def main(args: Array[String]): Unit = println(pack[Cons[Int, Cons[Int, End.type]], Cons[String, Cons[String, End.type]]](Cons[Int, Cons[Int, End.type]](1, Cons[Int, End.type](2, End))))
}
